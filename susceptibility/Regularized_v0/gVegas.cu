...
void gVegas(double& avgi, double& sd, double& chi2a)
{
   ...
   cudaMemcpyToSymbol(t0,          &t0_h,  sizeof(float));
   cudaMemcpyToSymbol(eA0a,      &eA0a_h,  sizeof(float));
   cudaMemcpyToSymbol(Gamm,      &Gamm_h,  sizeof(float));
   cudaMemcpyToSymbol(j0c,         &j0_h,  sizeof(float));
   cudaMemcpyToSymbol(j1c,         &j1_h,  sizeof(float));
   cudaMemcpyToSymbol(Gammsq,  &Gammsq_h,  sizeof(float));
   cudaMemcpyToSymbol(N,            &N_h,  sizeof(int));
   cudaMemcpyToSymbol(N2,          &N2_h,  sizeof(int));
   
   cudaMemcpyToSymbol(V0,  &V0_h,  sizeof(float));
   cudaMemcpyToSymbol(V1,  &V1_h,  sizeof(float));
