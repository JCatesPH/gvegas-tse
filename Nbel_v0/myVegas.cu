...
void myVegas(double& avgi, double& sd, double& chi2a)
{
   ...
   */
   ...
   checkCudaErrors(cudaMemcpyToSymbol(eE0,        &eE0_h,  sizeof(float)));
   checkCudaErrors(cudaMemcpyToSymbol(Gamm,      &Gamm_h,  sizeof(float)));
   checkCudaErrors(cudaMemcpyToSymbol(KT,          &KT_h,  sizeof(float)));
   ...
   checkCudaErrors(cudaMemcpyToSymbol(V0,  &V0_h,  sizeof(float)));
   checkCudaErrors(cudaMemcpyToSymbol(V2,  &V2_h,  sizeof(float)));
   checkCudaErrors(cudaMemcpyToSymbol(Fac,  &Fac_h,  sizeof(float)));
   checkCudaErrors(cudaMemcpyToSymbol(qx,  &qx_h,  sizeof(float)));
   checkCudaErrors(cudaMemcpyToSymbol(qy,  &qy_h,  sizeof(float)));
   cudaThreadSynchronize(); // wait for synchronize
   //----------------------------------
